...
--
-- Name: price_history_2025w50; Type: TABLE; Schema: public; Owner: your_db_user
--

CREATE TABLE public.price_history_2025w50 (
    market_id uuid NOT NULL,
    price numeric(18,10) NOT NULL,
    ts timestamp with time zone NOT NULL
);
...
ALTER TABLE public.price_history_2025w50 OWNER TO your_db_user;
...
ALTER TABLE public.settlements_id_seq OWNER TO your_db_user;
...
--
-- Name: price_history_2025w50; Type: TABLE ATTACH; Schema: public; Owner: your_db_user
--

ALTER TABLE ONLY public.price_history ATTACH PARTITION public.price_history_2025w50 FOR VALUES FROM ('2025-12-08 00:00:00+00') TO ('2025-12-15 00:00:00+00');
...
--
-- Name: price_history_2025w50 price_history_2025w50_pkey; Type: CONSTRAINT; Schema: public; Owner: your_db_user
--

ALTER TABLE ONLY public.price_history_2025w50
    ADD CONSTRAINT price_history_2025w50_pkey PRIMARY KEY (market_id, ts);
...
--
-- Name: price_history_2025w50_mid_ts_mid_ts_idx; Type: INDEX; Schema: public; Owner: your_db_user
--

CREATE INDEX price_history_2025w50_mid_ts_mid_ts_idx ON public.price_history_2025w50 USING btree (market_id, ts DESC);


--
-- Name: price_history_2025w50_ts_ts_idx; Type: INDEX; Schema: public; Owner: your_db_user
--

CREATE INDEX price_history_2025w50_ts_ts_idx ON public.price_history_2025w50 USING btree (ts DESC);


--
-- Name: price_history_2025w50_pkey; Type: INDEX ATTACH; Schema: public; Owner: your_db_user
--

ALTER INDEX public.price_history_pkey ATTACH PARTITION public.price_history_2025w50_pkey;
