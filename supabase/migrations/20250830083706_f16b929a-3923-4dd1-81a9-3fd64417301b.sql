-- Insert multi-choice event markets for each category with dates well into the future
...
-- Companies Category
(
    'Which tech company will have the highest market cap in 2027?',
    'Predict which technology company will lead global markets by market capitalization at the end of 2027.',
...
-- Crypto Category
(
    'Which cryptocurrency will have the best performance in 2026?',
    'A market predicting which major cryptocurrency will deliver the highest returns during 2026.',
...
-- Culture Category
(
    'Which streaming platform will win the most Emmy nominations in 2026?',
    'Predict which streaming service will receive the most Emmy Award nominations in the 2026 ceremony.',
...
-- Economics Category  
(
    'Which G7 country will have the fastest GDP growth in 2026?',
    'A prediction market on which G7 nation will achieve the highest GDP growth rate in 2026.',
...
-- Financials Category
(
    'Which stock will be the best performer in the Dow Jones in 2026?',
    'Predict which Dow Jones Industrial Average component will have the highest returns in 2026.',
...
(
    ...
    'A prediction market on which NBA franchise will win the 2025-26 NBA Finals championship.',
